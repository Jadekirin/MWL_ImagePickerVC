...
@interface MWL_AssetContainerViewCell ()<UIScrollViewDelegate>
@property (nonatomic,weak) UIScrollView *scrollView;
@property (nonatomic,weak) UIImageView *imageView;
@property (nonatomic,assign) CGPoint imageCenter;
@property (nonatomic,assign) BOOL ifAddVideo;
@end


@implementation MWL_AssetContainerViewCell
